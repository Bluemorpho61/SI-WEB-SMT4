...
<div
    ...
    <form class="mt-8 space-y-3" action="/stake/post-proyek" method="POST">
        @csrf
        <div class="sm:max-w-lg w-full p-10 bg-white rounded-xl z-10">
            ...
            <div class="grid grid-cols-1 space-y-2">
                ...
                <textarea id="deskripsi" rows="4" name="deskripsi"
                          ...
                          aria-valuetext="{{old('deskripsi')}}"></textarea>
            </div>
            <div class="grid grid-cols-1 space-y-2">
                ...
                <div class="relative max-w-fit">
                    <input type="date" id="jangka_deadline" name="jangka_deadline"
                           value="{{old('jangka_deadline')}}">
                </div>
            ...
            <div class="grid grid-cols-1 space-y-2">
                <label class="block mb-2 text-sm font-bold text-gray-500 dark:text-white"
                       for="multiple_files">Silahkan mengunggah beberapa lampiran pendukung mengenai proyek anda
                    (boleh
                    lebih dari 1)</label>
                <input
